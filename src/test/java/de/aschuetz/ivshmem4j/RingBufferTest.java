...
public class RingBufferTest {
    ...
    private SharedMemory memoryInput;

    private SharedMemory memoryOutput;
    ...
    public void before() throws Throwable {
        ...
        for (long i = 0; i < memoryInput.getSharedMemorySize(); i++) {
            memoryInput.write(i, (byte) 0);
        }

        bufferInput = new RingBuffer(memoryInput, 0, 64);
        bufferOutput = new RingBuffer(memoryOutput, 0, 64);
